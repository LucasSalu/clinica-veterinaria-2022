...
// CRUD    
    public PreparedStatement create(String nome, String end, String cep, String email, String telefone) {
        try {
        ...
        return (PreparedStatement) this.retrieveById(lastId("cliente","id"));
    }
    ...
    private Cliente buildObject(ResultSet rs) {
        ...
        try {
            cliente = new Cliente(rs.getInt("id"), rs.getString("nome"), rs.getString("telefone"), rs.getString("email"), rs.getString("cep"));
